function CheckBox() {
  return (
    <div className="relative flex flex-col text-gray-700  mx-auto max-w-md md:max-w-full bg-white shadow-md rounded-xl bg-clip-border">
      <nav className="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
        {/* Pavadinimas */}
        <div className="block font-sans text-base antialiased font-medium leading-relaxed text-blue-gray-900">
          Koks Jusu noras istraukti i sia apklausa?
        </div>
        {/* Ckeck boxas */}
        <div
          role="button"
